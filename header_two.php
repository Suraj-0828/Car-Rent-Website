    ...
    <div class="container-fluid">
        <div class="header-top-wrapper">
            <ul class="contact-list">
                <li>
                    <i class="fas fa-envelope"></i>
                    <a href="mailto: naidurentalsfj@gmail.com" class="link"> naidurentalsfj@gmail.com</a>
                </li>
                <li>
                    <i class="fas fa-map-marker-alt"></i>
                    7 Yawini Street, Lautoka.
                </li>
                <li>
                    <i class="fas fa-phone"></i>
                    <a target="_blank" href="tel:+679-870-8366">+679-870-8366</a>
                ...
                <div class="header-left">
                    <div class="logo">
                        <a href="index.php" class="header-logo-1">
                            <img class="logo-fix" src="assets/img/about/logo-3.png" alt="logo-img">
                        </a>
